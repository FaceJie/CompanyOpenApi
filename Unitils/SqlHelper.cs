...
namespace OpenApiLib
{
    public class SqlHelper
    {
        ...
        public static int ExecteNonQueryByTrans(string cmdText, params SqlParameter[] commandParameters)
        {
            return ExecteNonQueryByTrans(connectionString, CommandType.Text, cmdText, commandParameters);
        }

        public static int ExecteNonQueryByTrans(string connectionString,  CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
        ...
        #endregion
        public static List<T> QueryList<T>(string sql, params SqlParameter[] paras)
        {
            IDataReader reader = ExecuteReader(connectionString, CommandType.Text, sql, paras);
            //实例化一个List<>泛型集合  
        ...
        public static DataTableCollection GetTableByPrams(string connecttionString, CommandType cmdTye, string cmdText, List<SqlParameter> listPara)
        {
            SqlCommand cmd = new SqlCommand();
            DataSet ds = new DataSet();
            using (SqlConnection conn = new SqlConnection(SqlHelper.connectionString))
            {
                ...
                {
                    sda.SelectCommand.Parameters.AddRange(listPara.ToArray());
                    sda.Fill(ds);
                }
            }
            DataTableCollection table = ds.Tables;
        ...
        public static DataSet ExecuteDataSetText(string cmdText, List<SqlParameter> listPara)
        {
            return ExecuteDataSetByPrams(connectionString, CommandType.Text, cmdText, listPara);
        }
        public static DataSet ExecuteDataSetByPrams(string connecttionString, CommandType cmdTye, string cmdText, List<SqlParameter> listPara)
        {
            SqlCommand cmd = new SqlCommand();
            DataSet ds = new DataSet();
            using (SqlConnection conn = new SqlConnection(SqlHelper.connectionString))
        ...
        public static DataTableCollection GetTableByPrams(CommandType cmdTye, string cmdText, List<SqlParameter> listPara)
        {
            return GetTableByPrams(SqlHelper.connectionString, cmdTye, cmdText, listPara);
        }
        /// <summary>
        /// 存储过程专用
        /// </summary>
        ...
        public static DataTableCollection GetTableTextByParams(string cmdText, List<SqlParameter> listPara)
        {
            return GetTableByPrams(CommandType.Text, cmdText, listPara);
        }
        #endregion
