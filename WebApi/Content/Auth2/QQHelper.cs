...
namespace NFinal.OAuth
{
    public class QQHelper
    {
        ...
        {
            string send_url = "https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&client_id=" + config.oauth_app_id + "&client_secret=" + config.oauth_app_key + "&code=" + code + "&state=" + state + "&redirect_uri="
        ...
        /// <returns>Dictionary</returns>
        public static Dictionary<string, object> get_user_info(OAuthConfig config,string access_token, string open_id)
        {
        ...
        /// <param name="open_id">用户openid</param>
        /// <returns>Dictionary</returns>
        public static Dictionary<string,object> get_info(OAuthConfig config,string access_token, string open_id)
        {
